...
export class MenusPage {
  rootPageOne = AdminDashboardPage;
 ...
 pages: PageInterface[] = [
  { title: 'DASHBOARD', pageName: 'AdminDashboardPage', tabComponent: 'AdminDashboardPage', index: 0, icon: 'home' },
  { title: 'EMPLOYEE MANAGEMENT', pageName: 'LeadManagementPage', tabComponent: 'LeadManagementPage', index: 1, icon: 'md-people' },
