...
postListfive:any;
postListtwo:any;
  custome = {eid:"",aid:"",start_date:"",end_date:"",model:"",color:""}
  ...
  getEnqReport(){
    ...
    // let sdate = this.datePipe.transform(new Date(this.custome.start_date), 'dd/MM/yyyy');
     ...
     this.restProvider.getStock(this.custome.aid,this.custome.start_date,this.custome.end_date,this.custome.model,this.custome.color)
     .then(data => {
      this.postList =[];
      this.postListone=[];
      this.postListtwo=[];
