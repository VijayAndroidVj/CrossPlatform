...
public class deliverylistAdapter extends RecyclerView.Adapter<deliverylistAdapter.MyViewHolderone> {
    ...
    public deliverylistAdapter(List<deliverylist> list, Delivery mainActivity, AdapterListener listener) {
        this.list=list;
