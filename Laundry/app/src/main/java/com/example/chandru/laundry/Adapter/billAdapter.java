...
public class billAdapter extends RecyclerView.Adapter<billAdapter.MyViewHolderone> {
    ...
    public billAdapter(List<bill> list, Order mainActivity, AdapterListener listener) {
        this.list=list;
